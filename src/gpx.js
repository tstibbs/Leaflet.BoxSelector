L.Control.BoxSelector.Actions.Gpx = function(markers) {
	var output = '';
	...
	for (var i = 0; i < markers.length; i++) {
		...
		output += '\n        <name>' + name + '</name>';
		output += '\n    </wpt>';
		//TODO add description, at least link?
	}
	output += '\n</gpx>';
	console.log(output);

	var blob = new Blob([output], {type: "application/gpx+xml;charset=utf-8"});
	saveAs(blob, "trigs.gpx"); // requires https://unpkg.com/file-saver@1.3.3/FileSaver.min.js
}
